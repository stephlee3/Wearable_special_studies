...
p1 = drnk.data %>%
  ...
  theme_bw()+
  labs(y = 'average value', title= "Average activity during first 2h \ngroup by drinking status")+
...
p2 = drnk.data %>%
  ...
  geom_boxplot(aes(fill = key))+
  theme_bw()+
  labs(y = 'average value', title= "Average activity during the whole day \ngroup by drinking status")+
  theme(legend.position = "bottom",
        plot.title = element_text(hjust = 0.5))
...
## note that I'm using cyclic splines because I'm considering the whol day! If you're only considering a subset of 
